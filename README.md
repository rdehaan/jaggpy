...
- `enumerateFirstNOutcomes()` This method takes one additional argument `n` and prints the first `n` outcomes.
...
asp.enumerateOutcomes(scenario1, "kemeny", True)
bfs.enumerateFirstNOutcomes(scenario1, "kemeny", False, n=2)
```
